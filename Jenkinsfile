pipeline {
    ...
    stages {
        ...
        stage('Connecting to ansible') {
            steps{
                sshPublisher(publishers: [sshPublisherDesc(configName: 'ansible_server', transfers: [sshTransfer(cleanRemote: false, excludes: '', execCommand: 'ansible-playbook -u root /home/nick/Documents/ProjectWebApp/DeployBuild.yml', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '//home//webapp', remoteDirectorySDF: false, removePrefix: '', sourceFiles: '/home/nick/Documents/ProjectWebApp')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
            }
        }
    }
    post {
